...
public class ProfectConfig implements WebMvcConfigurer {
    ...
    //Estos metodos son solo para iternacionalizacion, cambio de idiomas
    @Bean
    ...
    //Define cual es la varible que cambia el idioma de los textos
    @Bean
    ...
    //Se agrega un "interceptor" para poder hacer el cambio del idioma
    @Override
